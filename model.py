...
from modules.context_emb import get_context_embedder
import torch.nn.functional as F
from modules.common import compose_context, unique
from modules.e3nn import get_e3_gnn
import torch
from modules.gvp.gvn import GVPerceptronVN, GVLinear
from torch.nn.modules.loss import _WeightedLoss
from modules.gvp.predict_heads import AtomEdgePredictor, PositionPredictor
...
class Pocket2Mol(nn.Module):
    ...
    def _add_results_to_context(self, sample_result, data):
        ...
        if 'end_switch' not in data['ligand_context']:
